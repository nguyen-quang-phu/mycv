...
{Clinger: Online dating platform (clinger.co)}{Oct 2024 -- Dec 2024}
\resumeItemListStart
...
{Merlin: Web financial practitioners in Singapore (iammerlin.co) }{Oct 2024 -- Dec 2024}
\resumeItemListStart
...
{Frontend Engineer}{}
\resumeItemListStart
\resumeItem{ Maintain existing code base, build UI and integrate factory management api.}
\resumeItemListEnd
{Tech stack:}{ Reactjs}
