...
\begin{flushleft}
	\leftskip 10pt
	I am a Full-stack Developer with 3,5+ years of professional experience building scalable web applications using modern technologies like React, Nextjs, Ruby on Rails. Strong understanding of system design, CI/CD pipelines, cloud infrastructure (AWS).
...
{Clinger: Online dating platform (clinger.co)}{Dec 2024 -- Feb 2025}
\resumeItemListStart
...
\resumeItemListEnd
{Tech stack:}{ Nextjs, Ruby on rails, Postgres}
...
\resumeSubheadingProject
{Crewcall: App planning for seamless crew sourcing and event management}{Apr 2024 -- Oct 2024}
\resumeItemListStart
...
\resumeItemListEnd
{Tech stack:}{ Ruby on rails, Reactjs, Postgres}
